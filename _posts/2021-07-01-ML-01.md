...
![Alt text](./img/2021-07-01-1.png)   
![Alt text](./img/2021-07-01-2.png "Convex function")   
![Alt text](./img/2021-07-01-3.png "Contour figure")   
...
![Alt text](./img/2021-07-01-4.png)   
![Alt text](./img/2021-07-01-5.png)
- Gradient Descent는 parameter를 동시에 update합니다.    
![Alt text](./img/2021-07-01-6.png)   
- $\alpha$는 learing rate로 의미하는 것은 얼마나 update를 큰 폭으로 할지를 결정해줍니다.    
![Alt text](./img/2021-07-01-7.png)
